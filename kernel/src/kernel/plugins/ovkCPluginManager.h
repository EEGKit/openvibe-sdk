...
namespace OpenViBE
{
	namespace Kernel
	{
		...
		public:
			...
			Plugins::IAlgorithm* createAlgorithm(const CIdentifier& classID, const Plugins::IAlgorithmDesc** ppAlgorithmDesc) override;
			Plugins::IAlgorithm* createAlgorithm(const Plugins::IAlgorithmDesc& rAlgorithmDesc) override;
			Plugins::IBoxAlgorithm* createBoxAlgorithm(const CIdentifier& classID, const Plugins::IBoxAlgorithmDesc** ppBoxAlgorithmDesc) override;
		...
		protected:
			...
			IPluginObjectT* createPluginObjectT(const CIdentifier& classID, const IPluginObjectDescT** ppPluginObjectDescT);
