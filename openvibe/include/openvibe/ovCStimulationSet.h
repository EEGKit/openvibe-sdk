...
namespace OpenViBE
{
	...
	public:
		...
		uint64_t getStimulationIdentifier(const size_t index) const override { return m_stimulationSet->getStimulationIdentifier(index); }
		uint64_t getStimulationDate(const size_t index) const override { return m_stimulationSet->getStimulationDate(index); }
		uint64_t getStimulationDuration(const size_t index) const override { return m_stimulationSet->getStimulationDuration(index); }
		bool setStimulationCount(const size_t n) override { return m_stimulationSet->setStimulationCount(n); }
		...
		bool setStimulationDate(const size_t index, const uint64_t date) override { return m_stimulationSet->setStimulationDate(index, date); }

		bool setStimulationDuration(const size_t index, const uint64_t duration) override { return m_stimulationSet->setStimulationDuration(index, duration); }
		...
		bool removeStimulation(const size_t index) override { return m_stimulationSet->removeStimulation(index); }
