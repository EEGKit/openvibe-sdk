...
if(NOT DEFINED TRIED_FIND_OVSDK)
	if(NOT CMAKE_BUILD_TYPE AND NOT CMAKE_GENERATOR MATCHES "Visual Studio*")
		message(FATAL_ERROR "Either specify a build type or use VS generator (for multi type builds)")
	elseif(NOT CMAKE_BUILD_TYPE AND CMAKE_GENERATOR MATCHES "Visual Studio*")
...
if(WIN32)
	...
	set(LIB_EXT lib)
	set(DLL_EXT dll)
	foreach( OUTPUTCONFIG ${CMAKE_CONFIGURATION_TYPES} ) # Replace with generator expression in CMake 3.5+
	...
	if(WIN32)
		foreach( OUTPUTCONFIG ${CMAKE_CONFIGURATION_TYPES} ) # Replace with generator expression in CMake 3.5+
			...
			install(
				...
				${OPENVIBE_SDK_PATH_${OUTPUTCONFIGU}}/bin/libexpatw.dll
