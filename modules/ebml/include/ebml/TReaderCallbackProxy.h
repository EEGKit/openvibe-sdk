...
namespace EBML
{
	...
	public:
		TReaderCallbackProxy1(COwnerClass& rOwnerObject, bool (COwnerClass::*mfpIsMasterChild)(const CIdentifier& rIdentifier), void (COwnerClass::*mfpOpenChild)(const CIdentifier& rIdentifier),
							  void (COwnerClass::*mfpProcessChildData)(const void* pBuffer, uint64_t size), void (COwnerClass::*mfpCloseChild)())
		...
		{
			if (m_mfpProcessChildData) { (m_rOwnerObject.*m_mfpProcessChildData)(pBuffer, size); }
		}
	...
	protected:
		...
		void (COwnerClass::*m_mfpProcessChildData)(const void* pBuffer, uint64_t size);
	...
	template <class COwnerClass, bool (COwnerClass::*mfpIsMasterChild)(const CIdentifier& rIdentifier), void (COwnerClass::*mfpOpenChild)(const CIdentifier& rIdentifier), void (COwnerClass::*mfpProcessChildData)(const void* pBuffer, uint64_t size), void (COwnerClass::*mfpCloseChild)()>
