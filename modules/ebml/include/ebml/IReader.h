...
namespace EBML
{
	...
	public:
		 ...
		 *
		 * When called by the reader, this function should tell it whether the node identified by \c rIdentifier is a master
		 ...
		 * node is identified by \c rIdentifier. After this call will follow whether a new \c openChild if this node is
