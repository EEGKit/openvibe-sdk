					...
					IF(NOT(${HAS_CUSTOM_DOCUMENTATION}))
						...
						IF(${PUBLISH_DOC_ASSETS})
							IF(IS_DIRECTORY ${FULLPATH}/doc)
								...
								INSTALL(DIRECTORY ${FULLPATH}/doc/ DESTINATION ${DOCUMENTATION_TEMP_DIRECTORY}/openvibe/box-algorithm-doc/dox-part/ FILES_MATCHING PATTERN "*.dox-part")
								INSTALL(DIRECTORY ${FULLPATH}/doc/ DESTINATION ${DOCUMENTATION_TEMP_DIRECTORY}/openvibe FILES_MATCHING PATTERN "*.dox")
								INSTALL(DIRECTORY ${FULLPATH}/doc/ DESTINATION ${DOCUMENTATION_TEMP_DIRECTORY}/openvibe PATTERN "*.dox-part" EXCLUDE PATTERN "*.dox" EXCLUDE)
							ENDIF()
