...
#define OVP_GD_Algorithm_SignalStreamDecoder_OutputParameterId_Sampling        						OpenViBE::CIdentifier(0x363d8d79, 0xeefb912c)
...
#define OVP_GD_Algorithm_SpectrumStreamEncoder_InputParameterId_Sampling         					OpenViBE::CIdentifier(0x02D25E1B, 0x76A1019B)
...
#define OVP_GD_Algorithm_MasterAcquisitionStreamEncoder_InputParameterId_SignalSampling           		OpenViBE::CIdentifier(0xb84ad0ca, 0x4f316dd3)
...
#define OVP_GD_Algorithm_SpectrumStreamDecoder_OutputParameterId_Sampling                			OpenViBE::CIdentifier(0x68442C12, 0x0D9A46DE)
...
#define OVP_GD_Algorithm_SignalStreamEncoder_InputParameterId_Sampling            			OpenViBE::CIdentifier(0x998710ff, 0x2c5cca82)
