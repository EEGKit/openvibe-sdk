...
#define OVTK_Algorithm_ScenarioExporter_NodeId_Scenario_Setting_Identifier              OpenViBE::CIdentifier(0x1845EA8E, 0x424AC232)
...
#define OVTK_Algorithm_ScenarioExporter_NodeId_Scenario_Input_Identifier                 OpenViBE::CIdentifier(0xFC45833A, 0xEE785EA2)
#define OVTK_Algorithm_ScenarioExporter_NodeId_Scenario_Input_TypeIdentifier             OpenViBE::CIdentifier(0x2AFF56A1, 0x4D2D03E3)
#define OVTK_Algorithm_ScenarioExporter_NodeId_Scenario_Input_Name                       OpenViBE::CIdentifier(0x3CA137F2, 0x60CB338E)
#define OVTK_Algorithm_ScenarioExporter_NodeId_Scenario_Input_LinkedBoxIdentifier        OpenViBE::CIdentifier(0x30780A0D, 0x03641BCC)
#define OVTK_Algorithm_ScenarioExporter_NodeId_Scenario_Input_LinkedBoxInputIndex        OpenViBE::CIdentifier(0x413A5131, 0x7BFA1941)
#define OVTK_Algorithm_ScenarioExporter_NodeId_Scenario_Input_LinkedBoxInputIdentifier   OpenViBE::CIdentifier(0x81AF5685, 0x188FEAD2)
...
#define OVTK_Algorithm_ScenarioExporter_NodeId_Scenario_Output_Identifier                OpenViBE::CIdentifier(0x5366EAD8, 0xBB57B9AE)
#define OVTK_Algorithm_ScenarioExporter_NodeId_Scenario_Output_TypeIdentifier            OpenViBE::CIdentifier(0x157E5B37, 0x142F4D94)
#define OVTK_Algorithm_ScenarioExporter_NodeId_Scenario_Output_Name                      OpenViBE::CIdentifier(0x2C6B06FD, 0x0973253F)
#define OVTK_Algorithm_ScenarioExporter_NodeId_Scenario_Output_LinkedBoxIdentifier       OpenViBE::CIdentifier(0x1F790DDB, 0x2E0A002C)
#define OVTK_Algorithm_ScenarioExporter_NodeId_Scenario_Output_LinkedBoxOutputIndex      OpenViBE::CIdentifier(0x53A515C8, 0x0B296360)
#define OVTK_Algorithm_ScenarioExporter_NodeId_Scenario_Output_LinkedBoxOutputIdentifier OpenViBE::CIdentifier(0xAC286F77, 0x18F7E33A)
...
#define OVTK_Algorithm_ScenarioExporter_NodeId_Box_Input_Identifier                     OpenViBE::CIdentifier(0x15FF57E3, 0xAD458EF2)
...
#define OVTK_Algorithm_ScenarioExporter_NodeId_Box_Output_Identifier                    OpenViBE::CIdentifier(0x4538EF5A, 0xFA511347)
...
#define OVTK_Algorithm_ScenarioExporter_NodeId_Box_Setting_Identifier                   OpenViBE::CIdentifier(0x45AF5442, 0xA46DA56B)
...
#define OVTK_Algorithm_ScenarioExporter_NodeId_MetadataEntry_Identifier                 OpenViBE::CIdentifier(0x85811583, 0x5242A4F3)
...
#define OVTK_Algorithm_ScenarioExporter_NodeId_Link_Source_BoxOutputIdentifier          OpenViBE::CIdentifier(0x458FAADC, 0xEED89711)
...
#define OVTK_Algorithm_ScenarioExporter_NodeId_Link_Target_BoxInputIdentifier           OpenViBE::CIdentifier(0x56899E5F, 0xA5D9C658)
