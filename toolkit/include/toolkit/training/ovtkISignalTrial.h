...
namespace OpenViBEToolkit
{
	...
	extern OVTK_API ISignalTrial& insertBufferSamples(ISignalTrial& trial, uint32_t sampleStart, uint32_t nSample, const double* buffer,
													  const ISignalTrial* srcTrial = nullptr);
	extern OVTK_API ISignalTrial& insertBufferTime(ISignalTrial& trial, uint64_t timeStart, uint32_t nSample, const double* buffer,
												   const ISignalTrial* srcTrial = nullptr);
} // namespace OpenViBEToolkit
