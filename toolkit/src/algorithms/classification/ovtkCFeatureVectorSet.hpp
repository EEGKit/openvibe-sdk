...
public:
	...
	std::string getElementLabel(const size_t index) const override { return m_Matrix->getDimensionLabel(m_DimensionIdx, index).c_str(); }
	bool setElementLabel(const size_t /*index*/, const std::string& /*elementLabel*/) override { return false; }
...
public:
	...
	bool setFeatureVectorCount(const size_t /*index*/) override { return false; }
