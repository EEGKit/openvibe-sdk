...
const std::vector<uint64_t> FIXED_POINT =
{
...
const std::vector<size_t> SAMPLINGS = { 100, 128, 512, 1000, 1024, 16000, 44100 };

/// <summary> Samples to test. </summary>
const std::vector<uint64_t> SAMPLES = { 0, 1, 100, 128, 512, 1000, 1021, 1024, 5005, 12345, 59876, 100000, 717893, 1000001 };

/// <summary> Epoch durations to test. </summary>
const std::vector<double> DURATIONS = { 0.01, 0.1, 0.2, 0.25, 0.5, 1.0, 1.1, 1.5, 2, 5, 10, 50, 100 };
...
{
	for (auto ref : Dataset::FIXED_POINT)
	{
