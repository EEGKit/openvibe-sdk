...
#define OVP_ClassId_BoxAlgorithm_BrainampFileWriter                            OpenViBE::CIdentifier(0x43B05251, 0x0151085D)
#define OVP_ClassId_BoxAlgorithm_BrainampFileWriterDesc                        OpenViBE::CIdentifier(0x09040FD9, 0x426E7123)
