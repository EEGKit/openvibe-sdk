	...
	namespace StreamCodecs
	{
		...
		public:
			...
			bool getAlgorithmPrototype(Kernel::IAlgorithmProto& prototype) const override
			{
				...
				prototype.addInputParameter(OVP_Algorithm_MasterAcquisitionEncoder_InputParameterId_SignalSampling, "Signal sampling rate", Kernel::ParameterType_UInteger);
				prototype.addInputParameter(OVP_Algorithm_MasterAcquisitionEncoder_InputParameterId_StimulationSet, "Stimulation set", Kernel::ParameterType_StimulationSet);
				...
				prototype.addInputParameter(OVP_Algorithm_MasterAcquisitionEncoder_InputParameterId_ChannelLocalisation, "Channel localisation", Kernel::ParameterType_Matrix);
				...
				prototype.addInputParameter(OVP_Algorithm_MasterAcquisitionEncoder_InputParameterId_EncodeChannelLocalisationData, "Encode channel localisation data", Kernel::ParameterType_Boolean);
