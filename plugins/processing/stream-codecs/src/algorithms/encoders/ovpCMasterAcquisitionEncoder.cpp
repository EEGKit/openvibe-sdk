...
{	
	...
	TParameterHandler<uint64_t> ip_ui64SubjectIdentifier(this->getInputParameter(OVP_Algorithm_MasterAcquisitionStreamEncoder_InputParameterId_SubjectIdentifier));
	...
	TParameterHandler<uint64_t> ip_ui64AcquisitionBufferDuration(m_pAcquisitionStreamEncoder->getInputParameter(OVP_Algorithm_AcquisitionStreamEncoder_InputParameterId_BufferDuration));
	...
	TParameterHandler<uint64_t> ip_ui64ExperimentInformationSubjectIdentifier(m_pExperimentInformationStreamEncoder->getInputParameter(OVP_Algorithm_ExperimentInformationStreamEncoder_InputParameterId_SubjectIdentifier));
	...
	TParameterHandler<uint64_t> ip_ui64ExperimentInformationSubjectAge(m_pExperimentInformationStreamEncoder->getInputParameter(OVP_Algorithm_ExperimentInformationStreamEncoder_InputParameterId_SubjectAge));
	TParameterHandler<uint64_t> ip_ui64ExperimentInformationSubjectGender(m_pExperimentInformationStreamEncoder->getInputParameter(OVP_Algorithm_ExperimentInformationStreamEncoder_InputParameterId_SubjectGender));
	...
	TParameterHandler<uint64_t> ip_ui64SignalSamplingRate(m_pSignalStreamEncoder->getInputParameter(OVP_Algorithm_SignalStreamEncoder_InputParameterId_SamplingRate));
