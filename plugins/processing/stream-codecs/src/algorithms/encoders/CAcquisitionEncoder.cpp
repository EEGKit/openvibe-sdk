#include "CAcquisitionEncoder.hpp"
...
bool CAcquisitionEncoder::initialize()
{
	...
	ip_bufferDuration.initialize(getInputParameter(AcquisitionEncoder_InputParameterId_BufferDuration));
	ip_experimentInfoStream.initialize(getInputParameter(AcquisitionEncoder_InputParameterId_ExperimentInfoStream));
	ip_signalStream.initialize(getInputParameter(AcquisitionEncoder_InputParameterId_SignalStream));
	ip_stimulationStream.initialize(getInputParameter(AcquisitionEncoder_InputParameterId_StimulationStream));
	ip_channelLocalisationStream.initialize(getInputParameter(AcquisitionEncoder_InputParameterId_ChannelLocalisationStream));
	ip_channelUnitsStream.initialize(getInputParameter(AcquisitionEncoder_InputParameterId_ChannelUnitsStream));
