#include "CExperimentInfoEncoder.hpp"
...
bool CExperimentInfoEncoder::initialize()
{
	...
	ip_ExperimentID.initialize(getInputParameter(ExperimentInfoEncoder_InputParameterId_ExperimentID));
	ip_experimentDate.initialize(getInputParameter(ExperimentInfoEncoder_InputParameterId_ExperimentDate));
	ip_subjectID.initialize(getInputParameter(ExperimentInfoEncoder_InputParameterId_SubjectID));
	ip_subjectName.initialize(getInputParameter(ExperimentInfoEncoder_InputParameterId_SubjectName));
	ip_subjectAge.initialize(getInputParameter(ExperimentInfoEncoder_InputParameterId_SubjectAge));
	ip_subjectGender.initialize(getInputParameter(ExperimentInfoEncoder_InputParameterId_SubjectGender));
	ip_LaboratoryID.initialize(getInputParameter(ExperimentInfoEncoder_InputParameterId_LaboratoryID));
	ip_pLaboratoryName.initialize(getInputParameter(ExperimentInfoEncoder_InputParameterId_LaboratoryName));
	ip_TechnicianID.initialize(getInputParameter(ExperimentInfoEncoder_InputParameterId_TechnicianID));
	ip_pTechnicianName.initialize(getInputParameter(ExperimentInfoEncoder_InputParameterId_TechnicianName));
