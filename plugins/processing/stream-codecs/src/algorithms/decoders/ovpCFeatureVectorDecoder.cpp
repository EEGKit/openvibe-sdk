...
void CFeatureVectorDecoder::processChildData(const void* pBuffer, const uint64_t ui64BufferSize)
{
	...
	{
		const uint32_t l_ui32DimensionCount = uint32_t(m_pEBMLReaderHelper->getUIntegerFromChildData(pBuffer, ui64BufferSize));
