	...
	namespace StreamCodecs
	{
		...
		public:
			...
			bool getAlgorithmPrototype(Kernel::IAlgorithmProto& prototype) const override
			{
				...
				prototype.addOutputParameter(OVP_Algorithm_ExperimentInfoDecoder_OutputParameterId_ExperimentID, "Experiment identifier", Kernel::ParameterType_UInteger);
				...
				prototype.addOutputParameter(OVP_Algorithm_ExperimentInfoDecoder_OutputParameterId_LaboratoryID, "Laboratory identifier", Kernel::ParameterType_UInteger);
				...
				prototype.addOutputParameter(OVP_Algorithm_ExperimentInfoDecoder_OutputParameterId_TechnicianID, "Technician identifier", Kernel::ParameterType_UInteger);
