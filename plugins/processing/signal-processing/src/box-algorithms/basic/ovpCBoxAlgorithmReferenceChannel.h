...
namespace OpenViBE
{
	...
	namespace SignalProcessing
	{
		...
		public:
			...
			{
				return CString("Subtracts the value of the reference channel from all other channels");
			}

			CString getDetailedDescription() const override
			{
				return CString("Reference channel must be specified as a parameter for the box");
			}
